...
public:
    ...
    {
        // Bitdrachma: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // Bitdrachma: get transaction coin age
...
public:
    ...
    // Bitdrachma: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // Bitdrachma: two types of block: proof-of-work or proof-of-stake
    ...
    // Bitdrachma: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // Bitdrachma: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // Bitdrachma: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // Bitdrachma: block index flags
    enum  
    {
