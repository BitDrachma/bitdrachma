...
// Bitdrachma: total coins staked (non-spendable until maturity)
...
// Bitdrachma: check 'spent' consistency between wallet and txindex
// Bitdrachma: fix wallet spent state according to txindex
...
// Bitdrachma: disable transaction (only for coinstake)
